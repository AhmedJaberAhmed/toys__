...
class Session {
        ...
        if (_imageUrl.isNotEmpty) {
          ...
          final DarwinNotificationDetails iOSPlatformChannelSpecifics =
              DarwinNotificationDetails(
                ...
                DarwinNotificationAttachment(_bigPicturePath)
              ]);
  ...
  Future saveUser(
      UserModel user, String cookie, String username, String password) async {
    ...
    data.setString("usernameBio", username);
    data.setString("passwordTemp", password);
  }

  Future saveBiometric(String email, String password) async {
    data.setString("emailBio", email);
    data.setString("passwordBio", password);
  }

  Future deleteBiometric() async {
    data.remove("emailBio");
    data.remove("passwordBio");
  }
