...
String dataFilterAttr = 'data-filter-attribute-by-category';
...
//Chat
String detailChat = 'detail-chat';
String insertChat = 'insert-chat';
String listBlog = 'list-blog';
String listUserChat = 'list-user-chat';
String inputImage = 'upload-image';
...
String customProductUrl = 'list-produk';
String cart = 'cart';
String checkoutDatas = 'checkout-datas';
String placeOrders = 'place-order';

// Account
String userDetail = 'get_currentuserinfo';
String updateUser = 'update_user_profile';
String checkPhone = 'check-phone-number';

//Affiliate
String affiliateDetail = "affiliate/dashboard";

//Membership
String membershipDetail = "memberships/products";
...
String newNotificationUrl = 'home-api/list-notification-new';
String readNotificationUrl = 'home-api/read-notification';
...
String insertAddress = shippingAddress + '/insert';
String updateAddress = shippingAddress + '/update';
String deleteAdress = shippingAddress + '/delete';
String setDefault = shippingAddress + '/set-default';
