            ...
            children: [
              WebView(
                ...
                onProgress: (int progress) {
                  ...
                  if (widget.title == "Tracking")
                    _webViewController?.runJavascript(
                        "document.querySelector('header').parentElement.nextElementSibling.style.padding = '0'; document.querySelector('header').parentElement.nextElementSibling.firstChild.remove(); document.querySelector('header').parentElement.remove() ");
                },
