...
class _ProductDetailShimmerState extends State<ProductDetailShimmer>
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  height: 5,
                  color: HexColor("FFEB3B"), // Bright yellow for visibility
                ),
                secondPart(),
                // Divider
                Container(
                ...
                fourthPart("You Might Also Like", isTitle: true),
                SizedBox(
                  height: 15,
                ),
                // Title for Featured Products
                fourthPart("Featured Products", isTitle: true),
                SizedBox(
                  height: 15,
                ),
                // Title for On Sale Now
                fourthPart("On Sale Now", isTitle: true),
                SizedBox(
                  height: 70.h,
                ),
              ],
  ...
  Widget fourthPart(String title, {required bool isTitle}) {
    return Column(
      children: [
        Container(
          width: double.infinity,
