...
class _ProductDetailModalState extends State<ProductDetailModal> {
  ...
  void addCart(ProductModel product) async {
    ...
    if (variationPrice != 0) {
      ...
      product.productStock = variationStock;
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  alignment: Alignment.center,
                                  child: InkWell(
                                      onTap: widget.productModel!.productStock! <=
                                                  widget.productModel!
                                                      .cartQuantity! ||
                                              isOutStock ||
                                              widget.productModel!.cartQuantity! >=
                                          ...
                                          : () {
                                              printLog(
                                                  "gak masuk minmax ${widget.productModel!.productStock!} $variationStock");
                                              setState(() {
                                                chekQty = false;
                                                errorText = "";
                                                if ((widget.productModel!
                                      ...
                                      child: widget.productModel!.productStock! >
                                                  widget.productModel!
                                                      .cartQuantity! &&
                                              !isOutStock &&
                                              widget.productModel!.minMaxQuantity!.maxQty >
                                                  widget.productModel!
                                                      .cartQuantity! &&
                                              ((widget.productModel!.cartQuantity! <
                                                          widget.productModel!.productStock! &&
                                                      widget.productModel!.type == "simple") ||
                                                  (widget.productModel!.cartQuantity! < variationStock! && widget.productModel!.type == 'variable'))
                                          ? Container(
                                              decoration: BoxDecoration(
                                                color: Colors.grey[400],
                                                shape: BoxShape.circle,
