      ...
      onBarrierClick: () {
        ...
        if (index == 0) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
            final home = Provider.of<HomeProvider>(homeContext, listen: false);
            if (home.bannerPopUp.first.image != null &&
              ...
              await showDialog(
                ...
                homeContext.read<HomeProvider>().changePopBannerStatus(false);
                  ...
                  onTap: () {
                    ...
                    if (index == 0) {
                      ...
                      WidgetsBinding.instance
                        ...
                        final home = Provider.of<HomeProvider>(homeContext,
                            listen: false);
                        if (home.bannerPopUp.first.image != null &&
                            home.bannerPopUp.first.image != "" &&
                            home.isBannerPopChanged &&
