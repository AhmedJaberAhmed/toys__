...
class ProductModel {
  ...
  List<DefaultVariationOption>? defaultVariationOption = [];
  List<SelectedAddOnProduct>? selectedAddOn = [];
  String? selectedAddOnString = "";
  String? videoId = "";
  ...
  ProductModel({
    ...
    this.addonProducts,
    this.defaultVariationOption,
    this.selectedAddOn,
    this.selectedAddOnString,
    this.videoId,
  ...
  Map toJson() => {
        ...
        'default_variation_option': defaultVariationOption,
        'selected_addons': selectedAddOn,
        'selected_addon_string': selectedAddOnString,
        'video_id': videoId,
  ...
  ProductModel.fromJson(Map json) {
    ...
    if (json['availableVariations'] != null) {
      ...
      for (int j = 0; j < availableVariations!.length; j++) {
        if (availableVariations![j].displayRegularPrice -
                availableVariations![j].displayPrice !=
            0) {
          double temp = ((availableVariations![j].displayRegularPrice -
                      availableVariations![j].displayPrice) /
    ...
    minMaxQuantity = json['minmax_quantity'] != null
        ? MinMaxQuantity.fromJson(json['minmax_quantity'])
        : MinMaxQuantity(1, 999);
    if (json['addon_products'] != null) {
      addonProducts = [];
      json['addon_products'].forEach((v) {
        addonProducts?.add(AddOnProducts.fromJson(v));
      });
    }
    if (json['default_variation_option'] != null) {
      defaultVariationOption = [];
      json['default_variation_option'].forEach((v) {
        defaultVariationOption?.add(DefaultVariationOption.fromJson(v));
      });
    }
    if (json['selected_addons'] != null) {
      selectedAddOn = [];
      json['selected_addons'].forEach((v) {
        selectedAddOn?.add(SelectedAddOnProduct.fromJson(v));
      });
    }
    if (json['selected_addon_string'] != null) {
      selectedAddOnString = json['selected_addon_string'];
    }
  }
...
class DefaultVariationOption {
  String? attributeSlug, variationValue;

  DefaultVariationOption({this.attributeSlug, this.variationValue});

  Map toJson() =>
      {'attribute_slug': attributeSlug, 'variation_value': variationValue};

  DefaultVariationOption.fromJson(Map json) {
    attributeSlug = json['attribute_slug'];
    variationValue = json['variation_value'];
  }
}

class SelectedAddOnProduct {
  String? fieldName;
  String? fieldType;
  String? id;
  String? name;
  ...
  SelectedAddOnProduct.fromJson(Map json) {
...
class AddOnProducts {
  String? id, name, type, fieldName;
  List<OptionAddOn>? options = [];

  AddOnProducts({this.id, this.name, this.type, this.fieldName, this.options});
  ...
  AddOnProducts.fromJson(Map json) {
    id = json['id'] ?? "";
    name = json['name'] ?? "";
    type = json['type'] ?? "";
    fieldName = json['field_name'] ?? "";
    if (json['options'] != null) {
      ...
      json['options'].forEach((v) {
        options?.add(OptionAddOn.fromJson(v));
      });
    }
  }
}
...
class OptionAddOn {
  ...
  OptionAddOn({this.label, this.price, this.image, this.priceType});

  Map toJson() =>
      {'label': label, 'price': price, 'image': image, 'price_type': priceType};

  OptionAddOn.fromJson(Map json) {
    label = json['label'] ?? "";
    price = double.parse(json['price'].toString());
    image = json['image'] ?? "";
    priceType = json['price_type'];
