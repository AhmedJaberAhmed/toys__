...
class ReviewProduct {
  ...
  ReviewProduct.fromJson(Map<dynamic, dynamic> json) {
    ...
    if (json['helpful_button'] != null && json['helpful_button'].isNotEmpty) {
      userVote = json['helpful_button']['user_vote'];
      totalUp = json['helpful_button']['total_up'];
      totalDown = json['helpful_button']['total_down'];
    }
    ...
    if (json['media_caption'] != null) {
      mediaCaption = [];
      json['media_caption'].forEach((v) {
        mediaCaption?.add(v);
      });
    }
  }
