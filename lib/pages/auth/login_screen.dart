        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Visibility(
                visible: Session.data.containsKey("emailBio") &&
                    Session.data.containsKey("passwordBio") &&
                    Session.data.getString("emailBio")! != "" &&
                    Session.data.getString("passwordBio")! != "",
                child: Column(
                  children: [
                    Container(
                      height: 15,
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        printLog(authenticate.toString(), name: "Authenticate");
                        setState(() {
                          authenticated = authenticate;
                        });
                        if (authenticated!) {
                          username.text = Session.data.getString('emailBio')!;
                          password.text =
                              Session.data.getString('passwordBio')!;
                          loginByDefault();
                        }
