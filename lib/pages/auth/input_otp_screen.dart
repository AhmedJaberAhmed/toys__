                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 12, color: HexColor(value.textColor)),
                      ),
                    ),
                    GestureDetector(
                          ...
                          GestureDetector(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontSize: 14,
                                color:
                                    time == null ? Colors.black : Colors.grey,
                              ),
                            ),
                          ),
                          Visibility(
    ...
    return PinFieldAutoFill(
      decoration: BoxLooseDecoration(
          textStyle: TextStyle(
              fontSize: 20,
              height: 1.2,
              color: context.read<HomeProvider>().design == "classic"
                  ? Colors.black
                  : Colors.white,
              fontWeight: FontWeight.bold),
          strokeColorBuilder: FixedColorBuilder(
              context.read<HomeProvider>().design == "classic"
                  ? primaryColor
                  : Colors.white),
          strokeWidth: 2),
      codeLength: 6,
