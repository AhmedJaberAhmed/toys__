...
class _SignUpState extends State<SignUp> {
  ...
  Widget passwordForm(String? hints, String? label,
      TextEditingController controller, bool visible, int idx, bool error) {
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            errorText: error
                ? AppLocalizations.of(context)!.translate('empty_field')
                : null,
  ...
  Widget form(String? hints, String? label, bool prefix, bool error,
