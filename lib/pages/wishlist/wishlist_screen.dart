  ...
  void initState() {
    ...
    scrollController.addListener(() async {
      if (scrollController.position.pixels >=
        ...
        if (wishlistProvider.listWishlistProduct.length % 8 == 0 &&
            wishlistProvider.loadingWishlist != true &&
            wishlistProvider.listWishlistProduct.isNotEmpty) {
          setState(() {
            page++;
          });
          await wishlistProvider
              ...
              .then(
                (value) async => await wishlistProvider.fetchWishlistProducts(
                  "${wishlistProvider.productWishlist}",
                  page: page,
                  isFromWishList: true,
                ),
              );
    ...
    Widget buildWishlist = Container(
      child: ListenableProvider.value(
        ...
        child: Consumer<WishlistProvider>(builder: (context, value, child) {
          if (value.loadingWishlist && page == 1) {
