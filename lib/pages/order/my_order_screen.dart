...
class _MyOrderState extends State<MyOrder> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      stringToCurrency(double.parse(orderModel.total!), context,
                          currencyDetail: orderModel.currencyDetail),
                      style: TextStyle(
  ...
  Widget buildTabStatus() {
    final localPickup = Provider.of<HomeProvider>(context, listen: false)
