          ...
          if (value.loadingUse) {
            return TextButton(
              ...
              child: Container(
                height: 15.h,
                width: 15.w,
                child: customLoading(color: secondaryColor),
              ),
            );
          }
          return TextButton(
            ...
            GestureDetector(
              onTap: () {
                showBarModalBottomSheet(
                    context: context,
                    backgroundColor:
                        Session.data.getString('themeMode') == 'light'
                            ? Colors.white
                            : Colors.grey,
                      ...
                      child: Text(
                        couponModel.discountType == "fixed_cart"
                            ...
                            : couponModel.discountType == "percent"
                                ? '${AppLocalizations.of(context)!.translate('you_will_get')} ${couponModel.amount!}% ${AppLocalizations.of(context)!.translate('discount_by')}'
