      ...
      await OrderAPI().addCart(action: "sync", line: line).then((data) {
        if (data != null && data.isNotEmpty) {
          ...
          productCart.forEach((element) {
            for (int i = 0; i < element.selectedAddOn!.length; i++) {
              if (i != element.selectedAddOn!.length - 1) {
                element.selectedAddOnString = element.selectedAddOnString! +
                    element.selectedAddOn![i].value! +
                    ", ";
              } else {
                element.selectedAddOnString = element.selectedAddOnString! +
                    element.selectedAddOn![i].value!;
    ...
    if (coupons.couponUsed != null) {
      setState(() {
        ...
        if (coupons.couponUsed!.discountType != "percent") {
          ...
          disc =
              "${stringToCurrency(double.parse(coupons.couponUsed!.discountAmount.toString()), context)} (${coupons.couponUsed!.amount}%)";
        }
      });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    productCart[index].variantId != null
                        ...
                        : Container(),
                    productCart[index].selectedAddOn != null &&
                            productCart[index].selectedAddOn!.isNotEmpty
                        ? Container(
                            child: Text(
                                "Topping : ${productCart[index].selectedAddOnString}",
                                style: TextStyle(
                                    fontSize: responsiveFont(9),
                                    fontStyle: FontStyle.italic)),
                          )
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              productCart[index].variationRegPrices!.isEmpty
                                  ? stringToCurrency(
                                      double.parse(
                    ...
                    Container(
                      child: Row(
                        ...
                        children: [
                          Text(
                            stringToCurrency(
                                productCart[index].priceTotal!, context),
                            style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: InkWell(
                                    onTap: () async {
                                      if (productCart[index].productStock !=
                                              null &&
