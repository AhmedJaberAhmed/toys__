...
class _CheckOutNativeState extends State<CheckOutNative> {
  ...
  loadData() async {
    ...
    final location = Provider.of<UserProvider>(context, listen: false)
        .customerData
        ?.location;
    LocationCoordinate address = LocationCoordinate(
  ...
  placeOrder() async {
    ...
    if (checkoutProvider!.titleCourier == "Choose Location" &&
    ...
    if (!Session.data.getBool('isLogin')!) {
      if (billing[13].contains('null')) {
        setState(() {
          billing[13] = '{"latitude": "","longitude": "","address": ""}';
        });
      }
        ...
        if (value['payment_link'] != "") {
          ...
          if (Session.data.getBool('isLogin')!) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => OrderSuccessAnimationScreen(),
                ));
          } else {
    ...
    Widget buildBody = Container(
      child: ListenableProvider.value(
        ...
        child: Consumer<CheckoutProvider>(builder: (context, value, child) {
          ...
          return buildAddress(value.user ?? UserData());
        }),
      ),
    );
            ...
            children: [
              Expanded(
                child: Consumer<UserProvider>(
                  builder: (context, val, child) => Consumer<CheckoutProvider>(
                    builder: (context, value, child) {
                      return value.loading || val.loading
                          ? Container(
                                        ...
                                        child: Row(children: [
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                ...
                                                0.8,
                                            child: Text(
                                              '${AppLocalizations.of(context)!.translate('use')} ${value.pointsRedemption!.point} ${AppLocalizations.of(context)!.translate('points_for')} ${stringToCurrency(value.pointsRedemption!.totalDisc!, context)} ${AppLocalizations.of(context)!.translate('discount_on_order')}',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700),
                                              softWrap: true,
                                              maxLines: 2,
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: [
                  ...
                  Container(
                    width: 230,
                    child: value.titleCourier !=
                                "${AppLocalizations.of(context)!.translate('select_courier')!}" &&
                            value.titleCourier !=
                                "${AppLocalizations.of(context)!.translate('select_pickup')!}"
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
            ...
            children: [
              ...
              Consumer<CheckoutProvider>(
                builder: (context, value, child) => Text(
                  value.titleShipping == "Courier"
                      ? "${AppLocalizations.of(context)!.translate('select_courier')!}"
                      : value.titleShipping == "Local Pickup"
                          ? "${AppLocalizations.of(context)!.translate('select_pickup')!}"
                          : "${AppLocalizations.of(context)!.translate('select_courier')!}",
                  style: TextStyle(
                      fontSize: 18,
                        ...
                        style: TextStyle(
                            ...
                            color: index == value.indexCourier
                                ...
                                : appNotifier!.isDarkMode
                                    ...
                                    : HexColor("#6e6e6e"))),
                    Text(
                        "${stringToCurrency(double.parse(value.listCourier![index!].cost!.toString()), context)}",
                        maxLines: 2,
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
          ...
          onTap: () {
            ...
            if (idx == 2) {
              ...
              setState(() {
                ...
                shipCost = value.shippingLines[index].totalCost!.toDouble();
              ...
              if (image != "coupon") {
                if (image == "truck") {
                  ...
                  for (int i = 0;
                    ...
                    } else if (checkoutProvider!.shippingLines[i].methodId ==
                            "biteship" ||
                        checkoutProvider!.shippingLines[i].methodId ==
                            "local_pickup_plus") {
                      listData
                          .add(checkoutProvider!.shippingLines[i].methodTitle!);
                    } else {
                      listData.add(
                          "${checkoutProvider!.shippingLines[i].methodTitle!} (${stringToCurrency(checkoutProvider!.shippingLines[i].totalCost!, context)})");
                    }
                  }
                }
                if (image == "card") {
