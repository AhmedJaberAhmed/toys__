...
class _SocmedScreenState extends State<SocmedScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            Visibility(
              ...
              child: cardMenu('whatsapp-logo', 'icon-message', 'WhatsApp',
                  '${AppLocalizations.of(context)!.translate('chat_us')}'),
            ),
            Visibility(
                visible: socmed.description['facebook'] != "",
                child: cardMenu('facebook-logo', 'icon-message', 'Facebook',
                    '${AppLocalizations.of(context)!.translate('follow_our_account')}')),
            Visibility(
            ...
            Visibility(
                ...
                child: cardMenu('youtube-logo', 'icon-message', 'YouTube',
                    '${AppLocalizations.of(context)!.translate('subscribe_our_channel')}')),
            Visibility(
  ...
  _launchFacebook(String url) async {
    if (url != "") {
      try {
        await launchUrl(Uri.parse("fb://profile/127033522911463"),
